 ...
 * @author shobha
 */
public class semester4_ResultForm extends org.apache.struts.action.ActionForm {
    
 String  engg,year,month,int_marks, tot_marks, result, final_result,ext_marks,htno,paper_result,paper_tot_marks,sem_paper_result,sem_paper_finalresult,sem_finalresult;
char sem;
