...
private String iti_code,olditi_code,iti_name,trade_name,rdd_approv,attempt_no,rddts,conv_approv,convts;
    ...
    public String getRdd_approv() {
        return rdd_approv;
    }

    public void setRdd_approv(String rdd_approv) {
        this.rdd_approv = rdd_approv;
    }
...
private String sem_nonsem,trade_code,dist_code,phase;
    ...
    String  strength, rank, adm_num;
    String fromd, tod, ipaddress, ssc_tot_marks, strength_fill, strength_vacant;
...
private String regid;
   ...
   // private int regid;
String trade_short, available, editoption, freeze, lable, dist_name;
    ...
    private String regid1,fname,phno,year_of_admission ;
