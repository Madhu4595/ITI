 ...
 * @author Narendra
 */
public class sscdsata_application_wsAction_new extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
        sscdsata_application_wsForm_new formvariable = (sscdsata_application_wsForm_new) form;
        ...
        Integer ssc_tot_marks = formvariable.getSsc_tot_marks();
        ...
        try {
            ...
            System.out.println("Current Phase...." + phse);

            String query = "select name,fname,mname,dob,sex,dist_name,l1mrk,l1grade,l1points,l2mrk,l2grade,l2points,"
                    + "l3mrk,l3grade,l3points,matmrk,matgrade,matpoints,scimrk,scigrade,scipoints,socmrk,socgrade,"
                    + "socpoints,gtot,gpa from ssc.ssc_data_" + sscyear + "_ap where rollno='" + rollno + "' "
                    + "and year='" + sscyear + "'";
            ps = conp.createStatement();
...
//dob=beans.MyUtil.ChDate1(dob);
                ...
                String sql;
                if (k == 0) {
                    sql = "INSERT INTO application(name, fname, addr, mname, phno, adarno, gender, caste,ssc_passed, "
                            + "inter_passed, inter_marks, local, pincode,phc, exservice, dob, trno, ssc_regno, ssc_year,"
                            + " phase, year) values ('" + name + "','" + fname + "','" + addr + "','" + mname + "',"
                            + "'" + phno + "','" + adarno + "','" + sex + "','" + caste + "','y','n'," + trno + ","
                            + "'" + local + "','" + pincode + "','" + phc + "','" + exser + "','" + dob + "'::date,"
                            + "'" + trno + "','" + rollno + "','" + sscyear + "',hstore(array['" + phse + "'],"
                            + "array['true']),'" + year + "' )";
                    ...
                    if (j > 0) {
                        ...
                        sql = "select regid from application where name='" + name + "' and fname='" + fname + "' "
                                + "and dob='" + dob + "'::date";
                    ...
                    sql = "update application  set name='" + name + "',fname='" + fname + "',addr='" + addr + "',"
                            + "mname='" + mname + "',phno='" + phno + "',adarno='" + adarno + "',gender='" + sex + "',"
                            + "caste='" + caste + "',local='" + local + "',pincode='" + pincode + "',phc='" + phc + "',"
                            + "exservice='" + exser + "',dob='" + dob + "'::date,trno='" + trno + "',"
                            + "ssc_regno='" + rollno + "',"
                            + "phase=(case when phase is null then '' else phase end)||hstore(array['" + phse + "'],"
                            + "array['true']),year='" + year + "' where regid = '" + regid + "'";
                    System.out.println(sql);
                    int j = 0;
                    try {
                        j = st.executeUpdate(sql);
