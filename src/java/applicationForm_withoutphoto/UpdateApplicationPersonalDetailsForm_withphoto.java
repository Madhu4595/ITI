 ...
 * @author SUBBAREDDY
 */
public class UpdateApplicationPersonalDetailsForm_withphoto extends org.apache.struts.action.ActionForm {
    ...
    public UpdateApplicationPersonalDetailsForm_withphoto() {
        super();
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        try {
            ...
            //Logger.getLogger(UpdateApplicationPersonalDetailsForm_withphoto.class.getName()).log(Level.SEVERE, null, ex);
        }
        if (regid == null || regid == "") {
        ...
        try {
            ...
            String dist_code = ses.getAttribute("ins_code").toString();
