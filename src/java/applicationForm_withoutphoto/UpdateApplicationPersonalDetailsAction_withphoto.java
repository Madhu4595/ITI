 ...
 * @author SUBBAREDDY
 */
public class UpdateApplicationPersonalDetailsAction_withphoto extends Action {

    private UpdateApplicationPersonalDetailsForm_withphoto updateApplicationPersonalDetailsForm;
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            String strval = "";
            String opr = "";
            updateApplicationPersonalDetailsForm = (UpdateApplicationPersonalDetailsForm_withphoto) form;
