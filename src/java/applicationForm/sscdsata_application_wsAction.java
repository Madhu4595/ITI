...
public class sscdsata_application_wsAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            String query = "select name,fname,mname,dob,sex,dist_name,l1mrk,l1grade,l1points,l2mrk,l2grade,l2points,l3mrk,l3grade,l3points,matmrk,matgrade,matpoints,scimrk,scigrade,scipoints,socmrk,socgrade,socpoints,gtot,gpa from ssc.ssc_data_2017_ap where rollno='" + rollno + "' and year='" + year + "' and stream='" + Stream + "'";
