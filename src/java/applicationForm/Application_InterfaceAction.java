...
public class Application_InterfaceAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
       ...
       FormFile ssccertificate = formvariable.getSsccertificate();
         FormFile castecertificate = formvariable.getCastecertificate();
          FormFile exservicecertificate = formvariable.getExservicecertificate();
        ...
        if (update.equals("update")) {
            ...
            String ssccertificate_name = ssccertificate.getFileName();
            String castecertificate_name = castecertificate.getFileName();
            String exservicecertificate_name = exservicecertificate.getFileName();
...
//                }
//            }
//              if (!("").equals(castecertificate_name)) {
//                try {
//                    if (check_regid.equalsIgnoreCase(regid)) {
//                        img_query = "update img_cand_photos set pic=? where regid=?";
//                        ps = con.prepareStatement(img_query);
...
//                }
//            }
//               if (!("").equals(exservicecertificate_name)) {
//                try {
//                    if (check_regid.equalsIgnoreCase(regid)) {
//                        img_query = "update img_cand_photos set pic=? where regid=?";
//                        ps = con.prepareStatement(img_query);
