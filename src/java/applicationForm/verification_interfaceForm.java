...
public class verification_interfaceForm extends org.apache.struts.action.ActionForm {

    private FormFile photo, imgqul, imgcaste;
    private String iti_code, iti_name, exs, ossc, type;
    private String ssc_regno, ssc_board, ssc_year, ssc_month,ssc_type;
    String pwd_category,ews,dual_mode,email;
    String reject_reason;
    String ssc_eq;

    public String getSsc_eq() {
        return ssc_eq;
    }

    public void setSsc_eq(String ssc_eq) {
        this.ssc_eq = ssc_eq;
    }
