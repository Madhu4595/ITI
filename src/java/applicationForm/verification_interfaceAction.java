 ...
 * @author APDCA
 */
public class verification_interfaceAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        String age_21 = beans.MyUtil.filterBad(request.getParameter("age_21"));
        String experience = beans.MyUtil.filterBad(request.getParameter("experience"));
        String est = beans.MyUtil.filterBad(request.getParameter("est"));
        
        System.out.println("ssc equivalent------->" + ssc_eq + tc + cc + pc + exsv + sc + nc + uidv + ewsv);
        
        String subjects = beans.MyUtil.filterBad(uf.getSubjects());
        long phno = 0;
        //String reason = uf.getReason();
        ...
        System.out.println("rej_reason" + reason);
        try {
        ...
        try {
            adarno = beans.MyUtil.filterBad(uf.getAdarno());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
       ...
       // if (!token.equals(id)) { return mapping.findForward("failure"); }
        ...
        System.out.println("condition in verification is");
        ...
        if (rej.equals("1")) {
            ...
            try {
                ...
                if (update.equals("update")) {
                    ...
                    st = con1.prepareStatement("Update student_application set app_status='R',reason='" + reason + "',user_id='" + ins_code + "',ip='" + ip + "',verified_date='" + entry_date + "',ssc_eq_marks='" + ssc_eq + "',tc='" + tc + "',caste_certificate='" + cc + "',ph_challenge='" + pc + "',ex_service='" + exsv + "',study_certificate='" + sc + "',nativity_certificate='" + nc + "',uidv='" + uidv + "',ewsv='" + ewsv + "',age_21='" + age_21 + "',experience='" + experience + "',est='" + est + "' where regid::character varying='" + ses.getAttribute("regid") + "'");
            ...
            try {
                ...
                st.setString(3, addr);
                System.out.println("in if set String1");
                try {
                ...
                st.setDate(8, temp);
                System.out.println("in if set String2");
                st.setString(9, gen);
                ...
                st.setInt(17, trno);
                System.out.println("in if set String3");
...
//        }
            ...
            if (inter_passed) {
                group = uf.getGroup();
                subject1_name = uf.subject1_name;
                subject2_name = uf.subject2_name;
                subject3_name = uf.subject3_name;
            ...
            if (update.equals("update")) {
                ...
                System.out.println("check_regid--->" + check_regid);
...
//          }
            ...
            try {
                ...
                if (commit) {
                    ...
                    psts = connect.prepareStatement("INSERT INTO application(regid, name, fname, addr, mname, phno, adarno, gender, caste,ssc_type,ssc_passed, inter_passed, inter_marks, local, pincode, ts, ip,uid, phc, exservice, dob, trno, ssc_regno, ssc_board, ssc_year,ssc_month, phase, year, university_area, data_flag, app_status,user_id,reason,email,pwd_category,economic_weaker_section,is_trainee_dual_mode,verified_date,verified_ip,ssc_eq_marks,tc,caste_certificate,ph_challenge,ex_service,study_certificate,nativity_certificate,uidv,ewsv,age_21,experience,est)(SELECT regid, name, fname, addr, mname, phno, adarno, gender, caste,ssc_type, ssc_passed, inter_passed, inter_marks, local, pincode, ts, ip, uid, phc, exservice, dob, trno, ssc_regno, ssc_board, ssc_year, ssc_month, phase, year, university_area, data_flag, app_status, user_id, reason,email,pwd_category,economic_weaker_section,is_trainee_dual_mode,verified_date,verified_ip,ssc_eq_marks,tc,caste_certificate,ph_challenge,ex_service,study_certificate,nativity_certificate,uidv,ewsv,age_21,experience,est FROM student_application where regid::character varying='" + regid + "')");
                    psts.executeUpdate();
