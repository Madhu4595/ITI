 ...
 * @author APDCA
 */
public class verification_print_action extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        ses.setAttribute("role_id", role_id);
        ...
        try {
            ...
            String sql = "select * from application where regid=?";
            ...
            if (rs.next()) {
                ...
                if (rs1.next()) {
                    ...
                    System.out.println("sssc total gpa----->" + rs1.getString("ssc_tot_gpa"));
                    ...
                    System.out.println("sssc total marks----->" + rs1.getString("ssc_tot_marks"));
                ...
                String ssc_type = rs.getString("ssc_type");
                System.out.println("ssccccccc-->" + ssc_type);
                ...
                Timestamp vdate = rs.getTimestamp("verified_date");
                SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
                String date = formatter.format(vdate);
                ses.setAttribute("verified_date", date);
                app_status = rs.getString("app_status");
                user_id = rs.getString("user_id");
                ses.setAttribute("userid", user_id);
                ses.setAttribute("phase", rs.getString("phase"));
