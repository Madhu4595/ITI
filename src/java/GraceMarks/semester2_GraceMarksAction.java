 ...
 * @author shobha
 */
public class semester2_GraceMarksAction  extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
        semester2_GraceMarksForm s2gf= (semester2_GraceMarksForm) form;
        String int_marks=s2gf.getInt_marks();
        String tot_marks=s2gf.getTot_marks();
        String result=s2gf.getResult();
        String final_result=s2gf.getFinal_result();
      String ext_marks=s2gf.getExt_marks();
        String htno=s2gf.getHtno();
        String paper_result=s2gf.getPaper_result();
        String paper_tot_marks=s2gf.getPaper_tot_marks();
        String sem_paper_result=s2gf.getSem_paper_result();
        String sem_paper_finalresult=s2gf.getSem_paper_finalresult();
